...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['operaciones'])) {
        if ($_POST['operaciones'] == 'Buscar') {
            if ($conexion) {
                $consulta = $conexion->query("SELECT * FROM Cursos WHERE Curso_Codigo = '$codigo'");

                if ($datos = $consulta->fetch_assoc()) {
                    $curso = $datos['Curso_nombre'];
                    $numero = $datos['Curso_Nmodulos'];
                    $codigocurso = $datos['Curso_Codigo'];
                }
            }
        }
        if ($_POST['operaciones'] == 'Actualizar') {
            if ($conexion) {
                ...
                UPDATE Cursos
                SET 
                    Curso_nombre = '$nomcurso',
                    Curso_Nmodulos='$nmodulos'
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="cursos">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="./crear-cursos.php">Registrar
                                        Cursos</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex ">
                                    <form action="" method="post" class="d-flex">
                                        <input type="text" name="codigo" placeholder="Ingresar Codigo del Curso" class="form-control" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" hidden>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="codigocurso" required value="<?php echo $codigocurso ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="nomcurso" required value="<?php echo $curso ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">N° Módulos</label>
                                                <div class="col-sm-9">
                                                    <input type="number" class="form-control" name="nmodulos" value="<?php echo $numero ?>" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" name="operaciones" value="Actualizar" class="btn btn-primary mr-2">
                                        Actualizar
                                    </button>
                                </form>
                                <span>
