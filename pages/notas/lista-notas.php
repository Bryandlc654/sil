                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['operaciones'])) {
                                            if ($_POST['operaciones'] == 'Todos') {
                                                $RolId = $_SESSION['usuario']['Rol_id'];
                                                if ($RolId == 1) {
                                                    $consulta = "SELECT u.Usuario_id AS 'N°', u.Usuario_dni AS 'DNI', u.Usuario_nombres AS 'Nombres', u.Usuario_apellidos AS 'Apellidos', c.Curso_nombre AS 'Curso', m.Modulo_nombre AS 'Módulo', n.Nota_1 AS 'Nota 1', n.Nota_2 AS 'Nota 2', n.Nota_3 AS 'Nota 3', n.Notas_Promedio AS 'Promedio', u.Usuario_distrito AS 'Sede' FROM Usuarios u JOIN Notas n ON u.Usuario_id = n.Usuario_id JOIN Modulos m ON n.Modulo_id = m.Modulo_id JOIN Cursos c ON m.Curso_id = c.Curso_id WHERE n.Nota_status = 1 and U.Sede_Id = $sedeId";
                                                } else if ($RolId == 4) {
                                                    $consulta = "SELECT u.Usuario_id AS 'N°', u.Usuario_dni AS 'DNI', u.Usuario_nombres AS 'Nombres', u.Usuario_apellidos AS 'Apellidos', c.Curso_nombre AS 'Curso', m.Modulo_nombre AS 'Módulo', n.Nota_1 AS 'Nota 1', n.Nota_2 AS 'Nota 2', n.Nota_3 AS 'Nota 3', n.Notas_Promedio AS 'Promedio', u.Usuario_distrito AS 'Sede' FROM Usuarios u JOIN Notas n ON u.Usuario_id = n.Usuario_id JOIN Modulos m ON n.Modulo_id = m.Modulo_id JOIN Cursos c ON m.Curso_id = c.Curso_id WHERE n.Nota_status = 1 ";
                                                } else {
                                                    $consulta = "";
