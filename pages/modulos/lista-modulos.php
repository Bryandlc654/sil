                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title">Módulos Curso Auxiliar de Educación
                                </h4>
                            </div>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        FROM Cursos AS c
                                        JOIN Modulos AS m 
                                         ON c.Curso_id = m.Curso_id and c.Curso_id = 1";
                        ...
                        <div class="card-body">
                            <br>
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title">Módulos Curso Auxiliar de Enfermería
                                </h4>
                            </div>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        FROM Cursos AS c
                                        JOIN Modulos AS m 
                                         ON c.Curso_id = m.Curso_id and c.Curso_id = 2";
                                        if ($resultado = $conexion->query($consulta)) {
                                            $contador = 1;
                                            while ($fila = $resultado->fetch_assoc()) {
                                                echo '
                        ...
                        <div class="card-body">
                            <br>
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title">Módulos Curso Auxiliar de Inyectoterapia
                                </h4>
                            </div>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        FROM Cursos AS c
                                        JOIN Modulos AS m 
                                         ON c.Curso_id = m.Curso_id and c.Curso_id = 3";
                                        if ($resultado = $conexion->query($consulta)) {
                                            $contador = 1;
                                            while ($fila = $resultado->fetch_assoc()) {
                                                echo '
                        ...
                        <div class="card-body">
                            <br>
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title">Módulos Curso Auxiliar de Fisioterapia y Rehabilitación
                                </h4>
                            </div>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        FROM Cursos AS c
                                        JOIN Modulos AS m 
                                         ON c.Curso_id = m.Curso_id and c.Curso_id = 4";
                                        if ($resultado = $conexion->query($consulta)) {
                                            $contador = 1;
                                            while ($fila = $resultado->fetch_assoc()) {
                                                echo '
                        ...
                        <div class="card-body">
                            <br>
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title">Módulos Curso Podología
                                </h4>
                            </div>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        FROM Cursos AS c
                                        JOIN Modulos AS m 
                                         ON c.Curso_id = m.Curso_id and c.Curso_id = 5";
                                        if ($resultado = $conexion->query($consulta)) {
                                            $contador = 1;
                                            while ($fila = $resultado->fetch_assoc()) {
                                                echo '
