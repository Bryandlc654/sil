                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title">Habilitar / Deshabilitar Usuarios</h4>
                                <div class="d-flex ">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['operaciones'])) {
                                            if ($_POST['operaciones'] == 'Buscar') {
                                                ...
                                                if ($resultado = $conexion->query($consulta)) {
                                                    while ($fila = $resultado->fetch_assoc()) {
                                                        ...
                                                        $statusctual = $fila['Usuario_status'];
                                                        switch ($statusctual) {
                                                            case 1:
                                                                $statusresultado = 'Activo';
                                                                break;
                                                            case 0:
                                                                $statusresultado = 'Desactivado';
                                                                break;
                                                        }
                                                        echo '
                                                        <tr>
                                                        ...
                                                        <input type="hidden" name="usuario_id" value="' . $dni . '">
                                            ...
                                            if ($_POST['operaciones'] == 'actualizar') {
                                                ...
                                                $consulta = "UPDATE Usuarios SET Usuario_status ='$status' WHERE Usuario_dni ='$usuario_id'";
