        ...
        if ($_POST['operaciones'] == 'Buscar') {
            if ($conexion) {
                ...
                if ($datos = $consulta->fetch_assoc()) {
                    ...
                    $fnacimiento = $datos['Usuario_fnacimiento'];
                    $fcreacion = $datos['Usuario_fcreacion'];
                    $genero = $datos['Usuario_sexo'];
                    $direccion = $datos['Usuario_direccion'];
                    $distrito = $datos['Usuario_distrito'];
                    $provincia = $datos['Usuario_provincia'];
                    $departamento = $datos['Usuario_departamento'];
                    $celular = $datos['Usuario_celular'];
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="genero">
                                                        <option <?php echo ($genero == '' ? 'selected' : ''); ?>>Elige una
                                                            opción</option>
