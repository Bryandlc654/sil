...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $nsede = isset($_POST['nsede']) ? $_POST['nsede'] : '';
    $sede_id = isset($_POST['sede_id']) ? $_POST['sede_id'] : '';
}
...
if (isset($_POST['operaciones'])) {
    if ($_POST['operaciones'] == 'Buscar') {
        if ($conexion) {
            $consulta = $conexion->query("SELECT * FROM Sedes WHERE Sede_Id='$nsede'");

            if ($datos = $consulta->fetch_assoc()) {
                $sede_id = $datos['Sede_Id'];
                $nombre_sede = $datos['Sede_nombre'];
                $direccion = $datos['Sede_direccion'];
                $institucion = $datos['Sede_institucion'];
                $distrito = $datos['Sede_distrito'];
                $provincia = $datos['Sede_provincia'];
                $departamento = $datos['Sede_departamento'];
            }
        }
        $conexion->close();
    }
        ...
        if ($conexion) {
            $consulta = $conexion->query("
                ...
                SET 
                    ...
                    Sede_institucion = '$institucion',
                    Sede_distrito = '$distrito',
                    Sede_provincia = '$provincia',
                    Sede_departamento = '$departamento'
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h4 class="card-title">Editar Sedes</h4>
                                    <div class="d-flex ">
                                        <form method="post" class="d-flex">
                                            <select class="form-control" name="nsede" required>
                                                <option>Elige una
                                                    opción</option>
                                                <option value="1">
                                                    Chincha</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="nombre_sede" value="<?php echo $nombre_sede; ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
